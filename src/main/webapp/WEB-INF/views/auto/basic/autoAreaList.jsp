...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/basic/autoArea/">区域列表</a></li>
		<shiro:hasPermission name="basic:autoArea:edit"><li><a href="${ctx}/basic/autoArea/form">区域添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="autoArea" action="${ctx}/basic/autoArea/" method="post" class="breadcrumb form-search">
