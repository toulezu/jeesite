...
<body> --%>
<!-- 用于显示左边div的二级及以下菜单，最多可以显示到4级，菜单的target默认是 src/main/webapp/WEB-INF/views/modules/sys/sysIndex.jsp里面的mainFrame -->
<div class="accordion" id="menu-${param.parentId}"><!-- 这里的循环显示二级菜单，只有折叠的功能 -->
		...
		<c:if test="${menu.parent.id eq (not empty param.parentId ? param.parentId:1) && menu.isShow eq '1'}"> 
			<div class="accordion-group">
				...
				<div id="collapse-${menu.id}" class="accordion-body collapse ${not empty firstMenu && firstMenu ? 'in' : ''}">
					<div class="accordion-inner"><!-- 这里的循环显示三级菜单，有点击功能 -->
							...
							<c:forEach items="${menuList}" var="menu2">
								<c:if test="${menu2.parent.id eq menu.id && menu2.isShow eq '1'}">
									<li><a data-href=".menu3-${menu2.id}"
										...
										<ul class="nav nav-list hide" style="margin: 0; padding-right: 0;"><!-- 这里的循环显示四级菜单，有点击功能 -->
